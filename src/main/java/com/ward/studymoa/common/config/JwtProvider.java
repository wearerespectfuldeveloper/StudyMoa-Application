...
public class JwtProvider {
    ...
    public String generateJwtToken(String userId, StudyUserRoleType roleType) {
        Claims claims = Jwts.claims().setSubject(userId);
        claims.put("auth", new SimpleGrantedAuthority(roleType.getRoleType()));
    ...
    public Authentication getAuthentication(String token) {
        UserDetails userDetails = userDetailsService.loadUserByUsername(getUserIdFromJwtToken(token));
